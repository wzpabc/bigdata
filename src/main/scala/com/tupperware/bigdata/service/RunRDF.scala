...
import com.tupperware.bigdata.service.SparkPi.loadProperties
...
object RunRDF extends IDEAConfig {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder().appName(this.getClass.getSimpleName.toString)
      ...
      .config("spark.sql.warehouse.dir", prop.get("spark.sql.warehouse.dir").toString).getOrCreate()
    import spark.implicits._

    val dataWithoutHeader = spark.read.
      option("inferSchema", true).
      option("header", false).
      csv("hdfs:///apps/data/c4/covtype.data")
    ...
    val data = dataWithoutHeader.toDF(colNames: _*).
      withColumn("Cover_Type", $"Cover_Type".cast("double")).limit(10000)
